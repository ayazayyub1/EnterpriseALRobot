...
def main():
    ...
    if WEBHOOK:
        updater.start_webhook(listen="0.0.0.0", port=PORT, url_path=TOKEN, allowed_updates=Update.ALL_TYPES, drop_pending_updates=KInit.DROP_UPDATES, wekhook_url= URL)
